 ...
 */
public class VenusInvokerRunnable extends MultiQueueRunnable {

    private static Logger logger = LoggerFactory.getLogger(VenusInvokerRunnable.class);
    ...
    //TODO 包装参数相关信息，裁剪参数
    public VenusInvokerRunnable(VenusFrontendConnection conn, Endpoint endpoint,
