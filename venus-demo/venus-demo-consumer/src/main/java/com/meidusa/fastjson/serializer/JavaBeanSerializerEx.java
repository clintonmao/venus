 ...
 */
public class JavaBeanSerializerEx extends SerializeFilterable implements ObjectSerializer {
    // serializers
    ...
    public JavaBeanSerializerEx(Class<?> beanType){
        this(beanType, (Map<String, String>) null);
    }

    public JavaBeanSerializerEx(Class<?> beanType, String... aliasList){
    ...
    public JavaBeanSerializerEx(Class<?> beanType, Map<String, String> aliasMap){
        this(TypeUtils.buildBeanInfo(beanType, aliasMap, null));
    }

    public JavaBeanSerializerEx(SerializeBeanInfo beanInfo) {
