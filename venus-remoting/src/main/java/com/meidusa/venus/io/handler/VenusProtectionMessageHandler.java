...
public class VenusProtectionMessageHandler implements MessageHandler<VenusFrontendConnection, Tuple<Long, byte[]>>, Initialisable {
    @Override
    ...
    private static Logger logger = LoggerFactory.getLogger(VenusProtectionMessageHandler.class);
